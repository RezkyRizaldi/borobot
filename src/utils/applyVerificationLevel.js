...
module.exports = (level) => {
	return {
		...
		[GuildVerificationLevel.Medium]: 'Must be registered on Discord for longer than 5 minutes',
		[GuildVerificationLevel.High]: 'Must be a member of the guild for longer than 10 minutes',
